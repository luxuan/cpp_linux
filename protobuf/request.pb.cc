...
void protobuf_AssignDesc_request_2eproto() {
  ...
  static const int Request_offsets_[2] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Request, uid_),
  };
  Request_reflection_ =
...
#ifndef _MSC_VER
const Request_CMD Request::SET;
const Request_CMD Request::GET;
const Request_CMD Request::INCR;
...
const int Request::kUidFieldNumber;
#endif  // !_MSC_VER
      ...
      case 1: {
        if (tag == 8) {
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::Request_CMD_IsValid(value)) {
            set_cmd(static_cast< ::Request_CMD >(value));
          } else {
